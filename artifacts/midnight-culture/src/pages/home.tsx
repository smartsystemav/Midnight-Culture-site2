      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="container relative z-20 px-6 py-28 text-center flex flex-col items-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 border border-primary/40 bg-primary/10 text-primary text-xs font-bold tracking-widest uppercase mt-8 mb-6" tracking-widest uppercase mb-6"
          >
